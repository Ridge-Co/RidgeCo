...
- ❓ Open questions still needed before building:
  - Alex loan starting balance: **resolved as an approximate placeholder — $210** (midpoint of Brett's given range, more than $150 and less than $275; purchase was a Ryobi combo kit at Home Depot, unrelated to the Jul 2 2026 RYOBI Tools account registration despite the date proximity, sometime March–mid-July 2026, exact receipt not locatable in the searchable mailbox). Brett accepted using a best-guess figure since the ledger tracks balance going forward regardless — correct it in the Hub once he confirms the real number. Still need: the deduction percentage and the cap (max per-deduction, or a total cap on the loan itself).
