...
- Personal to-dos (not builds, but Brett wants a mechanism):
  19. Talk to Juana and Cesar about using the Invoices section, not Estimates, once work is actually complete. Brett doesn't want to over-message them — wants the system-side status rework (#16) to eventually catch this automatically with a concise SMS, rather than a manual conversation alone.
