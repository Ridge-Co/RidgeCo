...
**Status:** DESIGN ONLY (Sep 26 2026). Nothing built. Brett's answers to all design questions are in Section 2 (updated Sep 26 2026, 3pm: Regina loan handling and backfill decided); no open questions remain (Section 11).
