...
| BACKLOG.md | v1.5 | Master backlog across all ventures — priorities, in progress, completed |
| CAPTURE_INBOX.md | v1.3 | Brett's zero-friction brain-dump inbox — CAP items, links to backlog, open questions. Read every session. |
| HANDWRITING_KEY.md | v1.4 | Reference for reading Brett's handwritten-note photos; grows over time. Seeded vocab + confirmed live reads from Scan_2019/2020/2030/2032/2104. |
