...
| BACKLOG.md | v1.18 | Master backlog across all ventures — priorities, in progress, completed |
| CAPTURE_INBOX.md | v1.18 | Brett's zero-friction brain-dump inbox — CAP items, links to backlog, open questions. Read every session. |
