...
| B-226 | Ridge Co | Inspection Scheduler — new venture line (rental-customer batching + AMSCRE routing) | Phase 1 (data model + admin onboarding + availability/blackout UI) starting now. See `INSPECTION_SCHEDULER_BUILD_BRIEF_v1.0.md`. |
