...
- B-127 · 🟠 **Built + tested Aug 22, not yet deployed — see BRETTOS INFRASTRUCTURE table below for current detail (this bullet was Aug 13 planning context, now superseded).** Model-routing layer — secure DIY multi-model router in Worker (cheap-by-default + escalate; Gemini+Claude direct; PAT-031). Brief: `MODEL_ROUTING_BUILD_BRIEF_v1.0`. `routeAI` reuses `logTelemetry` (B-128).
