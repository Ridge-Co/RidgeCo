...
| B-226 | Ridge Co | Inspection Scheduler — new venture line (rental-customer batching + AMSCRE routing) | 🟡 Phase 1 SHIPPED (data model + admin onboarding + availability/blackout UI, `inspect.html`, FEATURE_LOG rule 110) — pending Brett's first live pass. Phase 2 (outreach + booking page) next. See `INSPECTION_SCHEDULER_BUILD_BRIEF_v1.0.md`. |
